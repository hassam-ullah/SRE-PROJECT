...
public class AdminSearchStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(regno, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 350, 300, 40));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        s = sc.findStudentByName(name.getText());
        System.out.println("ass"+s.getName()+" "+
                s.getRegNo()+" "+
                s.getEmail()+" "+
                s.getGender()+" "+
                s.getAge()+" "+
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        StudentController sc = new StudentController();
        Student s = sc.findStudentByRegNo(regno.getText());
        ViewStudent vs = new ViewStudent(s);
        vs.show();
