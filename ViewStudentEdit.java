 ...
 * @author Dell
 */
public class ViewStudentEdit extends javax.swing.JFrame {

    /**
     * Creates new form ViewStudentEdit
     */
    public ViewStudentEdit() {
        initComponents();
    }
    Student stu = new Student();
    public ViewStudentEdit(Student s)
    {
        initComponents();
        this.stu=s;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        UpdateStudentEdit vse = new UpdateStudentEdit(stu);
        vse.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStudentEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewStudentEdit().setVisible(true);
            }
        });
    }
